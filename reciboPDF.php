...
class PDF_Recibo extends fpdfhtmlHelper {
	function Header() {
		global $rsSueldo;
		$this->Image('images/logo.jpg',150,null,10px);
...
$oPdf->MultiCell( 185, 6, 'Recibí de Discover Ushuaia Rent a Car, la suma de '.Format_toMoney($rsSueldo['monto']).' correspondiente a'.$haberes.'del mes de '.$meses[$rsSueldo['mes']]. ' de '.$rsSueldo['ano'], '','L');
$oPdf->Output();
?>
