<div id="menu" style="display:none; width: 320px; background: #fff; padding: 10px;">
    ...
    <?php } ?>
        ...
        <?php } ?>
    <?php if(ACCION_147){?>
        <div class="operaciones item" onclick="createWindow('w_gestionalertas','Gestion de Alertas','v2/gestion_alertas/index','1230','500'); $('#menu').hide();">
            Gestion de Alertas
        </div>
    <?php } ?>
        ...
        <?php } ?>
        <?php if(MENU_28){?>
        <div class="configuracion item" onclick="createWindow('w_unidads','Administrador de flota','v2/unidads/index','750','500'); $('#menu').hide();">
       ...
       <?php if(MENU_43){?>
        ...
        <?php } ?>
    <?php if(ACCION_147){?>
        <div class="configuracion item" onclick="createWindow('w_alertas','Alta y parametrizacion de Alertas','v2/alertas/index','1230','500'); $('#menu').hide();">
    ...
    <?php } ?>
       ...
       <?php if(MENU_40){?>
        ...
        <?php } ?>
        <?php if(MENU_40){?>
        <div class="onLine item" onclick="createWindow('w_descuentos','Opciones de Cobro/descuentos','v2/descuentos/index','1100','400'); $('#menu').hide();">
