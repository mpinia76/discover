<div class="content">
    ...
    <table width="100%" class="test">
        <tr>
        	<td style="width:25px;"></td>
        	<td style="width:25px;"></td>
            <td class="border2" style="width:320px;"><p style="font-size:12px;">Nombre y Apellido:  </p></td>
            <td class="border2" style="width:200px;"><p style="font-size:12px;">DNI/Pasaporte: </p></td>
            <td class="border2"><p style="font-size:12px;"> <?php echo utf8_encode('Teléfono: ');?> </p></td>
        </tr>
    </table>    
     <table width="100%" class="test">
        <tr>
        	...
        	<td style="width:10px;"></td>
            <td class="border2" style="width:400px;"><p style="font-size:12px;"><?php echo utf8_encode('Dirección: ');?>  </p></td>
            <td class="border2"><p style="font-size:12px;">Localidad/Provincia:  </p></td>
    ...
    <table width="100%" class="test">
        <tr>
        	<td style="width:25px;"></td>
        	<td style="width:25px;"></td>
            <td class="border2" style="width:280px;"><p style="font-size:12px;">Nro. Licencia Conducir: </p></td>
            <td class="border2" style="width:170px;"><p style="font-size:12px;">Vencimiento:  </p></td>
            <td class="border2"><p style="font-size:12px;"><?php echo utf8_encode('Lugar de Emisión: ');?> </p></td>
        </tr>
    </table>  
    <table width="100%"><tr><td></td></tr></table>
    <table width="100%" class="test">
...
<div class="content">
    ...
    <table width="100%" class="test">
        <tr>
        	<td style="width:25px;"></td>
        	<td style="width:25px;"></td>
            <td class="border2" style="width:320px;"><p style="font-size:12px;">Name and last name:  </p></td>
            <td class="border2" style="width:200px;"><p style="font-size:12px;">ID/Passport: </p></td>
            <td class="border2"><p style="font-size:12px;"> <?php echo utf8_encode('Phone: ');?> </p></td>
        </tr>
    </table>    
     <table width="100%" class="test">
        <tr>
        	...
        	<td style="width:30px;"><?php echo $this->Html->image('conductor2.PNG', array('width'=>'30px','height'=>'30px')); ?></td>
        	<td style="width:10px;"></td>
            <td class="border2" style="width:400px;"><p style="font-size:12px;"><?php echo utf8_encode('Address: ');?>  </p></td>
            <td class="border2"><p style="font-size:12px;">Town/Province:  </p></td>
    ...
    <table width="100%" class="test">
        <tr>
        	<td style="width:25px;"></td>
        	<td style="width:25px;"></td>
            <td class="border2" style="width:280px;"><p style="font-size:12px;">Driver License Number: </p></td>
            <td class="border2" style="width:170px;"><p style="font-size:12px;">Expiration:  </p></td>
            <td class="border2"><p style="font-size:12px;"><?php echo utf8_encode('Place of issue: ');?> </p></td>
        </tr>
    </table>  
    <table width="100%"><tr><td></td></tr></table>
    <table width="100%" class="test">
...
<div class="content">
    ...
    <table width="100%" class="test">
        <tr>
        	<td style="width:25px;"></td>
        	<td style="width:25px;"></td>
            <td class="border2" style="width:320px;"><p style="font-size:12px;">Nome e Sobrenome:  </p></td>
            <td class="border2" style="width:200px;"><p style="font-size:12px;">RG/Passaporte: </p></td>
            <td class="border2"><p style="font-size:12px;"> <?php echo utf8_encode('Telefone: ');?> </p></td>
        </tr>
    </table>    
     <table width="100%" class="test">
        <tr>
        	...
        	<td style="width:30px;"><?php echo $this->Html->image('conductor2.PNG', array('width'=>'30px','height'=>'30px')); ?></td>
        	<td style="width:10px;"></td>
            <td class="border2" style="width:400px;"><p style="font-size:12px;"><?php echo utf8_encode('Endereço: ');?>  </p></td>
            <td class="border2"><p style="font-size:12px;">Localidade / Estado:  </p></td>
    ...
    <table width="100%" class="test">
        <tr>
        	<td style="width:25px;"></td>
        	<td style="width:25px;"></td>
            <td class="border2" style="width:280px;"><p style="font-size:12px;"><?php echo utf8_encode('Nº Carteira de motorista: ');?></p></td>
            <td class="border2" style="width:170px;"><p style="font-size:12px;">Vencimento:  </p></td>
            <td class="border2"><p style="font-size:12px;"><?php echo utf8_encode('Local de emissão: ');?> </p></td>
        </tr>
    </table>  
    <table width="100%"><tr><td></td></tr></table>
    <table width="100%" class="test">
