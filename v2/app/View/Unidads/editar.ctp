...
<div class="ym-grid">
    ...
    <table class="table" style="width: 100%">
        ...
        <tr>
            ...
            <td>
                <input name="unidadAlerta_id[]" id="unidadAlerta_id_<?php echo $i ?>" type="hidden" value="<?php echo $unidadalerta['id'] ?>"/>
            </td>
            <td><select name="alerta[]" id="alerta_<?php echo $i ?>" style="width: 200px;" onChange="cambiarAlerta(<?php echo $i ?>)"><option value="">Seleccionar...</option>'+
            ...
            <td>
                <?php
                    if ($unidadalerta['gestionNoPendiente']==1){?>
                        <input name="inactiva[]" id="inactiva_<?php echo $i ?>" type="checkbox" <?php echo ($unidadalerta['inactiva'])?'checked="checked"':''; ?>/>
                    <?php }
                    else { ?>
                        <a href="#" class="removealerta"><img src="../../img/bt_anular.png" align="absmiddle"></a>
                    <?php }
                ?>
