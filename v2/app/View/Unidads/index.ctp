    ...
    oTable = $("#dataTable").dataTable( {
        ...
        "fnDrawCallback": function( oSettings ) {
            $("#dataTable tr").unbind("dblclick").dblclick(function(){
                ...
                createWindow("w_unidads_view","Ver unidad","'.$this->Html->url('/unidads/editar', true).'/"+data[0],"450","400");
            });
...
<ul class="action_bar">
    <li class="boton agregar"><a onclick="createWindow('w_unidads_add','Alta de Unidad','<?php echo $this->Html->url('/unidads/crear', true);?>','450','300');">Alta de Unidad</a></li>
