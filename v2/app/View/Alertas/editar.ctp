...
//formulario
echo $this->Form->create(null, array('url' => '/alertas/editar','inputDefaults' => (array('div' => 'ym-gbox'))));
echo $this->Form->hidden('Alerta.id');
?>
...
<span id="botonGuardar" onclick="guardar('<?php echo $this->Html->url('/alertas/guardar.json', true);?>',$('form').serialize(),{id:'w_alertas',url:'v2/alertas/index'});" class="boton guardar">Guardar <img src="<?php echo $this->webroot; ?>img/loading_save.gif" class="loading" id="loading_save" /></span>
